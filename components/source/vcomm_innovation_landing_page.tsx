...
export default function VCOMMInnovationPage() {
  const [activeTab, setActiveTab] = useState('all');

  return (
    <div className="min-h-screen bg-slate-100 py-10 px-4 sm:px-6 lg:px-8 font-sans flex justify-center items-center">
      <div className="max-w-[1140px] w-full bg-white rounded-2xl shadow-xl p-6 sm:p-10 border border-slate-200 text-slate-900">
